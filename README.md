...
- [*mcrPioda*](https://cran.r-project.org/package=mcrPioda): this is a fork of the mcr package with additional M- and MM-Deming regressions and the function for the MD test.
